...
export default function CTA() {
    ...
    async function fetchSettings() {
      ...
      if (data) {
        setSettings({
          cta_eyebrow:
            data.cta_eyebrow ||
            fallbackSettings.cta_eyebrow,

          cta_heading:
            data.cta_heading ||
            fallbackSettings.cta_heading,

          cta_description:
            data.cta_description ||
            fallbackSettings.cta_description,

          cta_primary_label:
            data.cta_primary_label ||
            fallbackSettings.cta_primary_label,

          cta_primary_href:
            data.cta_primary_href ||
            fallbackSettings.cta_primary_href,

          cta_secondary_label:
            data.cta_secondary_label ||
            fallbackSettings.cta_secondary_label,

          cta_secondary_href:
            data.cta_secondary_href ||
            fallbackSettings.cta_secondary_href,

          show_cta_section:
            data.show_cta_section ??
            true,
        });
      }
  ...
  if (
    !loading &&
    settings.show_cta_section === false
  ) {
    return null;
  }
